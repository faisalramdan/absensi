                        ...
                        <form method="GET">
                            <div class="row align-items-end g-3">
                                ...
                                <div class="col-md-4 d-flex align-items-end gap-2">
                                    <a href="{{ route('attendance-monthly.index') }}"
                                        class="btn btn-secondary px-3 flex-fill">Reset</a>
                                    <button type="submit"
                                        class="btn btn-primary px-3 flex-fill d-inline-flex align-items-center justify-content-center gap-1">
                ...
                <div class="col-xl-12 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-transparent py-3">
                            <h5 class="card-title mb-0 fw-semibold text-dark">Ringkasan Statistik Kehadiran (Total Makro)
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-wrap gap-2">
                                                    ...
                                                    <span
                                                        class="badge bg-primary-subtle text-primary border border-primary-subtle px-2 py-1.5 fw-semibold">
                                                    ...
                                                    <span class="badge bg-light text-dark border px-2 py-1.5 fw-semibold"
                                                        style="background-color: #f3e5f5; color: #8e24aa !important; border-color: #d1c4e9 !important;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold text-warning">{{ number_format($cards['late'] ?? 0) }}
                                                    Kali</span>
                                                @if(($cards['total_late_minutes'] ?? 0) > 0)
                                                    <span class="text-muted small ms-2">
                                                        (Total durasi: {{ $cards['late_hours'] }} Jam
                                                        {{ $cards['late_minutes_remainder'] }} Menit)
                                                    </span>
                                                @endif
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold"
                                                    style="color: #00796b;">{{ number_format($cards['early_leave'] ?? 0) }}
                                                    Kali</span>
                                                @if(($cards['total_early_leave_minutes'] ?? 0) > 0)
                                                    <span class="text-muted small ms-2">
                                                        (Total durasi: {{ $cards['early_leave_hours'] }} Jam
                                                        {{ $cards['early_leave_minutes_remainder'] }} Menit)
                                                    </span>
                                                @endif
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-dark">
                                                ...
                                                <span class="text-muted small ms-2">
                                                    (Dari {{ $calendarDays ?? '0' }} hari kalender - {{ $sundayCount }} Off
                                                    - {{ $holidayCount }} Libur)
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="table-danger">
                                            ...
                                            <td class="fs-5 fw-bold text-danger">
                                                @if(isset($cards['kurang_jam']) && $cards['kurang_jam'] > 0)
                                                    {{ floor($cards['kurang_jam'] / 60) }} <small
                            ...
                            <table class="table table-bordered table-hover align-middle mb-0">
                                <thead class="table-light text-muted small">
                                    <tr>
                                        ...
                                        <th class="text-center" style="background-color: #fff5f5;">Kurang Dari <BR> Jam
                                            Kerja</th>
                                        <th class="text-center" style="background-color: #fff5f5;">Total Kurang <BR> Jam
                                            Kerja</th>
                                ...
                                <tbody>
                                    @forelse($summary as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center @if($item['alpha'] > 0) text-danger fw-bold @endif">
                                                                            {{ $item['alpha'] }}
                                                                        </td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            @if($item['late'] > 0)
                                                                                <span
                                                                                    class="badge bg-warning-subtle text-warning fw-semibold">{{ $item['late'] }}</span>
                                                                            @else
                                                                        ...
                                                                        <td class="text-center fw-medium text-danger" style="background-color: #fffdfd;">
                                                                            {{ $item['short_work_count'] ?? 0 }}x
                                                                        </td>
                                                                        <td class="text-center fw-medium @if($item['kurang_jam'] > 0) text-danger @endif"
                                            ...
                                            'end_date' => $endDate
                                        ]) }}" class="btn btn-sm btn-light border p-1 d-inline-flex align-items-center"
                                                                                title="Lihat Detail">
                                        ...
                                        <tr>
                                            <td colspan="16" class="text-center py-5 text-muted">
                                                <iconify-icon icon="solar:document-text-broken"
                                                    class="fs-40 text-muted mb-2 d-block mx-auto"></iconify-icon>
